...
```powershell
python -m uv run mod-manual validate
python -m uv run mod-manual validate --allow-en-us-stubs
python -m uv run mod-manual build patchouli --mod <modid>
python -m uv run mod-manual sync en-us-stubs --mod <modid>
...
```powershell
python -m uv run mod-manual sync en-us-stubs --mod <modid>
python -m uv run mod-manual validate --mod <modid> --allow-en-us-stubs
python -m uv run mod-manual build patchouli --mod <modid>
```
